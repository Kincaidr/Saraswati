...
def size_dist(S_all, sizes_all,flux_0,sizes_0, bin_centers, observed_medians, k_fit, m_fit):
    ...
    plt.tick_params(axis='both', which='major', direction='in', length=8, width=1.5, labelsize=14)
    plt.tick_params(axis='both', which='minor', direction='in', length=4, width=1, labelsize=14)
    plt.tight_layout()
...
def CCDF_plot(theta_med_1 ,theta_med_2,theta_vals, ccdf_emp,theta_lims_grid):
    ...
    ax1.tick_params(axis='both', which='major', direction='in', length=4, width=1.5,labelsize=14)
    ax1.tick_params(axis='both', which='minor', direction='in', length=8, width=1,labelsize=14)
    ...
    ax2.tick_params(axis='both', which='major', direction='in', length=8, width=1.5,labelsize=14)
