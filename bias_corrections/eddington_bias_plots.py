...
def compute_eddington_bias(name,line,gamma_values):
    ...
    ax1.axvline(11e-3, color='purple', linestyle='-',linewidth=2)
    ax1.axvline(16e-3, color='orange', linestyle='-',linewidth=2)
    ...
    ax2.set_ylabel(r'$S_{obs}/S_{true}$',size=22)
    ax2.set_xlabel('Flux density (mJy)',size=22 )
    ax2.axvline(11e-3, color='purple', linestyle='-',linewidth=2)
    ax2.axvline(16e-3, color='orange', linestyle='-',linewidth=2)     
