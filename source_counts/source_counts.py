...
def corrections(numbers,deltaS,centres,counts_norm,counts_err,source_count_literature,source_count_literature_DEEP,source_count_literature_SuperCLASS,completeness_corr, resolution_corr):
    ...
    axs[0].set_ylabel(r'$S^{2.5}dN/dS$ [sr$^{-1}$ Jy$^{1.5}$]', fontsize=18)
    axs[0].legend()
    ...
    axs[0].tick_params(axis='both', which='major', direction='in', length=8, width=1.5)
    axs[0].tick_params(axis='both', which='minor', direction='in', length=4, width=1)
    ...
    axs[1].set_xlabel(r'$S_{1.4 GHz}$ [mJy]', fontsize=18)
    axs[1].set_ylabel(r'$S^{2.5}dN/dS$ [sr$^{-1}$ Jy$^{1.5}$]', fontsize=18)
    ...
    axs[1].tick_params(axis='both', which='major', direction='in', length=8, width=1.5, labelsize=14)
    axs[1].tick_params(axis='both', which='minor', direction='in', length=4, width=1, labelsize=14)
    plt.tight_layout()
