...
def flux_plot(data, path, plots):
    ...
    plt.savefig(plots+'flux_scale.png')
    plt.show()
...
if __name__ == "__main__":
    ...
    path='/home/kincaid/Desktop/Saraswati_codes/A2631/flux_scale/ddfacet_VLA/'
    data=np.loadtxt(path+'Flux_comparison.txt')
    flux_plot(data, path, plots)
