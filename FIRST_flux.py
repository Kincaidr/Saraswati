...
def plot(cat1,freq1,freq2):
        ...
        mask= (flux1/rms > 100) & (flux1/peak1 > 0.8) & (flux2/peak2 > 0.8)  & (flux1/peak1 < 1.2) & (flux2/peak2 < 1.2) 
        table=table[mask]
        flux1 = table['Total_flux']*1e3
        flux2 = table['Fint']
        peak1=table['Peak_flux']*1e3
        ...
        if freq1 > freq2:
                flux2_corr= flux2* (freq1 / freq2)**-0.7
                flux2_corr_err= flux2_err * (freq1 / freq2)**-0.7
                flux1_corr = flux1
                flux1_corr_err= flux1_err 
        else:  
...
if __name__ == "__main__":
    freq1 = 1.283
    freq2 = 1.4  
    cat1='A2631_Zwcl_combined_ddfacet_FIRST.fits'
