...
def astrometry_VLASS(MeerKAT_NVSS_cat):
       ...
       # plt.scatter(delta_DEC[~sel21],delta_RA[~sel21], c="b", marker="o", alpha=0.2)
        ...
        plt.xlabel(r'$\delta_{MeerAKT} - \delta_{VLASS}$',fontsize=27)
        plt.ylabel(r'$\alpha_{MeerAKT} - \alpha_{VLASS}$',fontsize=27)
        ...
        plt.tight_layout()
        plt.savefig('plots/VLASS_astrometry.png', bbox_inches='tight', pad_inches=0.1,dpi=300)
        plt.show()
